...
- [Config 基础](/codex/configuration/config-basic)
- [高级配置](/codex/configuration/config-advanced)
- [配置参考](/codex/configuration/config-reference)
- [沙箱和审批](/codex/agent-approvals-security#sandbox-and-approvals)
- [托管配置](/codex/administration/enterprise/managed-configuration)
