...
![ChatGPT 工作区 RBAC 设置中的访问令牌权限](/images/codex/enterprise/rbac_access_token_access_permission.png)
...
![访问令牌页面，带有创建按钮](/images/codex/enterprise/access_token_create_header.png)

1. 前往 **访问令牌** 页面
2. 选择 **创建**

![创建访问令牌弹窗，包含名称和过期时间字段](/images/codex/enterprise/access_token_creation_modal.png)
...
- [认证](/codex/enterprise/authentication)
- [非交互模式](/codex/automation/non-interactive-mode)
- [管理员设置](/codex/enterprise/admin-setup)
- [治理](/codex/enterprise/governance)
