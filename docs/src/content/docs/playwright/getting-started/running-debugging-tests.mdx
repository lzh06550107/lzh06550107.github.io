...
可以直接在 VS Code 中使用 [VS Code 扩展](https://marketplace.visualstudio.com/items?itemName=ms-playwright.playwright) 来运行测试。安装后，你只需点击目标测试旁边的绿色三角形，或从测试侧边栏运行全部测试。更多细节请查看我们的《开始使用 VS Code》指南。
